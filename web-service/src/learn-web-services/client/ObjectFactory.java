 ...
 * generated in the org.learn.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://web.learn.org/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://web.learn.org/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.learn.web
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web.learn.org/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web.learn.org/", name = "helloWorldResponse")
