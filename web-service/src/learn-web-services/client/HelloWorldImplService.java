 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://web.learn.org/", wsdlLocation = "http://localhost:2345/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://web.learn.org/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2345/WS/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://web.learn.org/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web.learn.org/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
